            ...
            success:function (data) {
                if (data.connected) {
                    ...
                    for (var i in patients) {
                        ...
                        var row = '<div class="patient_row " onclick="patient.goto_patient_page('+patients[i].user_id+');"><span class="next_arrow"></span>' + patients[i].last_name + ', ' + patients[i].first_name + '</div>';
                        $('#patients_list').append(row);
                    }
                }
                else {
